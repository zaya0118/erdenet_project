<div class="w-64 overflow-y-auto h-[calc(100%-4rem)] shadow-md bg-white absolute bg-gray-50 p-2">
    <div id="alert-additional-content-2" class="p-4 mb-4 border border-red-300 rounded-lg bg-red-50 dark:bg-red-200" role="alert">
        <div class="flex items-center">
            ...
            <h3 class="text-lg font-medium text-red-900 dark:text-red-800">Эрсдэлтэй байршил</h3>
        </div>
        ...
        <div class="flex">
            <button type="button" class=" mr-2 text-red-900 bg-transparent border border-red-900 hover:bg-red-900 hover:text-white focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center dark:border-red-800 dark:text-red-800 dark:hover:text-white" data-dismiss-target="#alert-additional-content-2" aria-label="Close">
                Хаах
            </button>
            <button type="button" class="text-white bg-red-900 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-xs px-3 py-1.5 text-center inline-flex items-center dark:bg-red-800 dark:hover:bg-red-900">
