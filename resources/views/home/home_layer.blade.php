...
<div class="h-full shadow-md bg-white w-[384px] fixed bg-gray-50" id="sidebar">
  ...
  <div class="p-4 grid grid-cols-4 gap-4 inline-flex items-center justify-items-center">
    ...
    <div class="text-center flex-col">
      <button type="button" onclick="layerMore('organization')" class="w-12 h-12 text-sky-700 border-4 border-sky-700/80 focus:ring-4 focus:outline-none focus:ring-sky-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center justify-center">
